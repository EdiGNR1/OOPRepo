...
public class Example {
    ...
    public static void main(String[] args) throws ElectiveException {
        ...
        electiveCourses.addCourse("VIQ", 3); //1
        electiveCourses.addCourse("AI", 1); //esaurito
        electiveCourses.addCourse("OR", 1); //esaurito
        
        System.out.println("Elective courses: " + electiveCourses.getCourses());
        
        electiveCourses.loadStudent("S1", 25.5); //3
        electiveCourses.loadStudent("S2", 27);  //2
        electiveCourses.loadStudent("S3", 25.5); //3
        electiveCourses.loadStudent("S4", 28);  //1
        electiveCourses.loadStudent("S5", 22);  //4
        ...
        System.out.println("Success rate for first choice: " + success*100); // 60.0
