...
public class TestApp {
	...
	public void test() throws SMException {
		...
		//System.out.print(sm.receiptGetTotal(rc));
		...
		int pC = sm.addPurchase(1000, 50, "pa2", "ra1");
//		System.out.println(sm.getPurchaseDiscount(purchaseCode));
		System.out.println(sm.getPurchaseDiscount(pC));
